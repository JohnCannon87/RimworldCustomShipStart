...
namespace GravshipExport.Blueprints
{
    ...
    public class Designator_PlaceShipFoundationRoot : Designator
    {
        public Designator_PlaceShipFoundationRoot()
        {
            defaultLabel = "Place ship floor blueprint";
        ...
        public override void ProcessInput(Event ev)
        {
            ...
            foreach (var layout in layouts)
            {
                ...
                options.Add(new FloatMenuOption(cap, () =>
                {
                    ...
                    var child = new Designator_PlaceShipFoundation(layout);
